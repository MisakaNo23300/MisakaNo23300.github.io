...
;console.log('当前代码仅为演示用,不能二次开发。源码只发布在: https://www.bootstrapmb.com/item/14543(此说明只在演示页面有,不在下载的源码里) ');if(location.href.indexOf('ile:')<0){if(location.href.indexOf('oo')<0){parent.location='https%3a%2f%2fwww.bootstrapmb.com%2fitem%2f14543'}};